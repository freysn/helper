...
// #ifndef M_VEC
// #warning "old compatibility mode is deprecated now, #define M_VEC"
// #define M_VEC
// #endif
...
__host__ __device__
#endif
V2<T> minv(const V2<T>& a, const V2<T>& b)
{
#ifndef __CUDACC__
  using namespace std;
#endif
...
__host__ __device__
#endif
V2<T> maxv(const V2<T>& a, const V2<T>& b)
{
#ifndef __CUDACC__
  using namespace std;
#endif
...
__host__ __device__
#endif
  V3<T> maxv(const V3<T>& a, const V3<T>& b)
{
  #ifndef __CUDACC__
  using namespace std;
  #endif
...
__device__ __host__
#endif
friend inline  V4<T> operator/(V4<T> a, T b)
{
  a.x /= b;
  a.y /= b;
  a.z /= b;
...
__device__ __host__
#endif
friend inline  V4<T> operator/(V4<T> a, V4<T> b)
{
  a.x /= b.x;
  a.y /= b.y;
  a.z /= b.z;
...
// template<typename T0, typename T1>
// inline  void operator*=(V2<T0> &a, const V2<T1>& b)
// {
//   a.x *= b.x;
//   a.y *= b.y;
// }
